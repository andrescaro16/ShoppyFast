    ...
    <div className='product-card'>
            ...
            <div className='card-content-container'>
                ...
                <CardActions disableSpacing className='cart-actions'>
                    ...
                    <ButtonGroup>
                        <Button className="primary-button"  style={{ backgroundColor: "#009EC9" }} onClick={() => setQuantity(quantity > 1 ? quantity - 1 : 1)}>-</Button>
                        <Badge className='button-group center' color="primary">{quantity}</Badge>
                        <Button  className="primary-button"  style={{ backgroundColor: "#009EC9" }} onClick={() => setQuantity((quantity + 1) <= product.cantidad ? quantity + 1 : quantity)}>+</Button>
                    </ButtonGroup>
