    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='/pago/transaccion' element={<Transaccion total={total} setUserAccount={setUserAccount} />} />
          <Route path='/pago/transaccion/confirmacion' element={< Purchase setUserValidation={setUserValidation} userValidation={userValidation} userAccount={userAccount} userPurchase={userPurchase} />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
